    ...
    <main>
        ...
        <aside>
            ...
            <section>
                ...
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="glutenfree"><input class="d-none"
                    type="checkbox" name="glutenfree" id="glutenfree"/>gluténmentes</label>
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="sugarfree"><input class="d-none"
                    type="checkbox" name="sugarfree" id="sugarfree" />cukormentes</label>
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="milk-free"><input class="d-none" type="checkbox"
                    name="milk-free" id="milk-free" />tejmentes</label>
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="egg-free"><input class="d-none" type="checkbox"
                    name="egg-free" id="egg-free" />tojásmentes</label>
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="laktosefree"><input class="d-none" type="checkbox"
                    name="laktosefree" id="laktosefree" />laktózmentes</label>
                <label class="m-button -fontSize-14 p-3 mr-2 -colorBgTernary" for="vegan"><input class="d-none" type="checkbox"
